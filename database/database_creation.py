...
def scrape_song_info(chart,start_date,end_date):
    ...
    '''Scrape weekly chart data and Spotify information for each track on Billboard Charts
...
def populate_sql(artist_id, spotify, gracenote_clientID, gracenote_userID):
    ...
    # Use fuzzy matching the align Gracenote search results with Spotify tracks.
    ...
    # Reorganize Spotify and Gracenote data into three table for psql database.
...
charting_tracks = scrape_song_info('hot-100','2015-01-01', '2016-01-01')
